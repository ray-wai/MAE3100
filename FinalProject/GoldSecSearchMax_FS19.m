...
%%Raymond Waidmann
%%18157816, rcw5k2
%%MAE 3100, Final Project Golden Section Search for Max Function
...
%%maximum is located and returns that value to the calling program. 

function [xOpt] = GoldSecSearchMax_FS19(f,xl,xu)
...
while(ea > es)
    ...
    if (-f(xA) < -f(xB)) %%minus needed since we are finding Max
